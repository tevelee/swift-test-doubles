...
public typealias ExternalNullaryClosure = () -> Int
public typealias ExternalNullaryThrowingClosure = () throws -> Int
public typealias ExternalNullaryAsyncClosure = () async -> Int
public typealias ExternalNullaryAsyncThrowingClosure = () async throws -> Int
public typealias ExternalSendableNullaryThrowingClosure =
    @Sendable () throws -> Int
public typealias ExternalSendableNullaryAsyncClosure =
    @Sendable () async -> Int
public typealias ExternalSendableNullaryAsyncThrowingClosure =
    @Sendable () async throws -> Int
public typealias ExternalPairThrowingClosure =
    (Int, Int) throws -> Int
public typealias ExternalPairAsyncClosure =
    (Int, Int) async -> Int
public typealias ExternalPairAsyncThrowingClosure =
    (Int, Int) async throws -> Int

public protocol ExternalGeneratedBridgeCoverageService {
    func nullary(
        _ closure: @escaping ExternalNullaryClosure
    ) -> ExternalNullaryClosure
    func nullaryThrowing(
        _ closure: @escaping ExternalNullaryThrowingClosure
    ) -> ExternalNullaryThrowingClosure
    func nullaryAsync(
        _ closure: @escaping ExternalNullaryAsyncClosure
    ) -> ExternalNullaryAsyncClosure
    func nullaryAsyncThrowing(
        _ closure: @escaping ExternalNullaryAsyncThrowingClosure
    ) -> ExternalNullaryAsyncThrowingClosure
    func sendableNullaryThrowing(
        _ closure: @escaping ExternalSendableNullaryThrowingClosure
    ) -> ExternalSendableNullaryThrowingClosure
    func sendableNullaryAsync(
        _ closure: @escaping ExternalSendableNullaryAsyncClosure
    ) -> ExternalSendableNullaryAsyncClosure
    func sendableNullaryAsyncThrowing(
        _ closure: @escaping ExternalSendableNullaryAsyncThrowingClosure
    ) -> ExternalSendableNullaryAsyncThrowingClosure
    func pairThrowing(
        _ closure: @escaping ExternalPairThrowingClosure
    ) -> ExternalPairThrowingClosure
    func pairAsync(
        _ closure: @escaping ExternalPairAsyncClosure
    ) -> ExternalPairAsyncClosure
    func pairAsyncThrowing(
        _ closure: @escaping ExternalPairAsyncThrowingClosure
    ) -> ExternalPairAsyncThrowingClosure
}

public struct RealExternalGeneratedBridgeCoverageService:
    ExternalGeneratedBridgeCoverageService
{
    public init() {}

    public func nullary(
        _ closure: @escaping ExternalNullaryClosure
    ) -> ExternalNullaryClosure { closure }

    public func nullaryThrowing(
        _ closure: @escaping ExternalNullaryThrowingClosure
    ) -> ExternalNullaryThrowingClosure { closure }

    public func nullaryAsync(
        _ closure: @escaping ExternalNullaryAsyncClosure
    ) -> ExternalNullaryAsyncClosure { closure }

    public func nullaryAsyncThrowing(
        _ closure: @escaping ExternalNullaryAsyncThrowingClosure
    ) -> ExternalNullaryAsyncThrowingClosure { closure }

    public func sendableNullaryThrowing(
        _ closure: @escaping ExternalSendableNullaryThrowingClosure
    ) -> ExternalSendableNullaryThrowingClosure { closure }

    public func sendableNullaryAsync(
        _ closure: @escaping ExternalSendableNullaryAsyncClosure
    ) -> ExternalSendableNullaryAsyncClosure { closure }

    public func sendableNullaryAsyncThrowing(
        _ closure: @escaping ExternalSendableNullaryAsyncThrowingClosure
    ) -> ExternalSendableNullaryAsyncThrowingClosure { closure }

    public func pairThrowing(
        _ closure: @escaping ExternalPairThrowingClosure
    ) -> ExternalPairThrowingClosure { closure }

    public func pairAsync(
        _ closure: @escaping ExternalPairAsyncClosure
    ) -> ExternalPairAsyncClosure { closure }

    public func pairAsyncThrowing(
        _ closure: @escaping ExternalPairAsyncThrowingClosure
    ) -> ExternalPairAsyncThrowingClosure { closure }
}
