...
@Suite struct DynamicSelfResultTests {
    ...
    @Test func ordinaryOptionalSameProtocolExistentialResultsStillSelectCallPattern() {
        _ = configureOrdinaryOptionalPeer
    }

    @Test func ordinarySameProtocolExistentialResultsStillSelectCallPattern() {
        _ = configureOrdinaryPeer
    }

    @Test func ordinaryStaticExistentialResultsStillSelectCallPattern() throws {
