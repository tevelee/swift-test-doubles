...
@Suite struct UnusedStubDetectionTests {
    @Test func reportsRegistrationsNeverMatchedByAnyCall() throws {
        ...
        stub.onCall { $0.value(for: Match.any()) }.thenReturn("used")
    ...
    @Test func reportsARegistrationShadowedByAnEarlierCatchAll() throws {
        ...
        stub.onCall { $0.value(for: Match.any()) }.thenReturn("broad")
        expectReportsIssue {
            stub.onCall { $0.value(for: Match.equal(7)) }.thenReturn("specific")
        } matching: {
    ...
    @Test func manualStubReportsUnusedRegistrations() {
        ...
        stub.onCall { $0.value(for: Match.equal(1)) }.thenReturn("one")
        stub.onCall { $0.value(for: Match.equal(2)) }.thenReturn("two")
