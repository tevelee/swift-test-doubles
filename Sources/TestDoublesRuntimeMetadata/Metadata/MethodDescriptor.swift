...
extension RuntimeValueConvention {
    fileprivate init(_ convention: WitnessValueConvention) {
        switch convention {
            ...
            case .nestedOptionalSelf: self = .nestedOptionalSelf
            case .arraySelf: self = .arraySelf
            case .optionalArraySelf: self = .optionalArraySelf
...
private func witnessValueDescription(
    ...
    switch value.dependency.legacyProjection {
        ...
        case .result, .metatype, .genericClass, .genericValue:
            break
